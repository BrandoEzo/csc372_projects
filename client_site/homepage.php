<!--Brandon Ezovski, 2/4/2026: This is the homepage for the URI Gaming Club's official website, featuring basic information and links. -->
...
<html lang="en">
  ...
  <head>
    ...
    <meta name="description" content="Homepage for the URI Gaming Club's official website, featuring basic information on what the club does, who runs it, and how to join">
    <meta charset="UTF-8">
    <title>URI Gaming Club Homepage</title>
  ...
  <body>  
    ...
    <p class="center">Welcome to the URI Gaming Club homepage!</p>

    <div class="welcomeImages">
      <img src="images/20251210_191433.jpg" alt="Rhody the Ram playing Wii Sports" fetchpriority="high" width="640" height="480">
    </div>
    ...
    <div class="all-content">
      <div class="left-col">
        <div class="card">
          ...
          <p>We are an official URI Club focused on Video Games, Board Games, Card Games, and more! Our club provides a space
        ...
        <div class="card">
          ...
          <p>We are located in room 312A of the URI Memorial Union, and host events out of the club room, room 360 across the hall,
        ...
        <div class="card">
          ...
          <p>Unlike most clubs, URI Gaming Club does not have traditional weekly or monthly meetings. We typically have one meeting
        ...
        <div class="card">
          <h2>How to join</h2>
          <p>We have no official signups for Gaming Club, but we recommend anyone interested in our events joins our Discord server,
      ...
      <div class="right-col">
        <div class="interestCard">
          <h3>Interested in joining the club?</h3>
                    <p id="uri_weekly">Currently interested:</p>
                    <img class="interestImage" src="images/interested_question_button.png" alt="interested">
        ...
        <div class="card">
          ...
          <ul>
            <li><a href = "https://discord.gg/Ad5kMyEX82" target="_blank">URI Gaming Club Discord Server</a></li>
            <li><a href ="https://x.com/smash_uri" target="_blank">URI Smash Bros Twitter Account</a></li>
            <li><a href ="https://www.youtube.com/@HowlingRI" target="_blank">RI Super Smash Bros Youtube Channel</a></li>
            <li><a href ="https://events.uri.edu/group/gaming_club" target="_blank">URI Gaming Club Rhody Connect Page</a></li>
          </ul>
        </div>
        ...
        <div class="card">
          ...
          <ul>
            <li>President: Jack Henderson</li>
            <li>Vice President: Sam Cerullo</li>
            <li>Treasurer: Dominick Garbarino</li>
            <li>Secretary: Brandon Ezovski</li>
          </ul>
        </div>
    ...
    <div class="welcomeImages"> 
      <img src="images/20251210_195547.jpg" alt="Rhody the Ram playing Wii Sports" fetchpriority="high" width="640" height="480">
    </div>
    </main>
